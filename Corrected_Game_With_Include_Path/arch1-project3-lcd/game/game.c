...
// Legend of Zelda Melody
#define SONG_LENGTH 24
short melody[SONG_LENGTH] = {
    440, 440, 440, 349, 440, 523, 440, 349, 440, 349, 440, 523,
    440, 349, 440, 440, 440, 349, 440, 523, 440, 349, 440, 349
};
short noteDurations[SONG_LENGTH] = {
    250, 250, 250, 500, 250, 500, 250, 250, 250, 500, 250, 500,
    250, 250, 250, 500, 250, 250, 250, 500, 250, 250, 250, 500
};

void playGameStartTune() {
    int currentNote = 0;
    while (currentNote < SONG_LENGTH) {
        buzzer_set_period(melody[currentNote]);
        __delay_cycles(noteDurations[currentNote] * 1000);
        currentNote++;
    }
...
void drawGameScreen() {
    ...
    fillRectangle(0, objectRow - ENEMY_SIZE, 128, ENEMY_SIZE, BG_COLOR);
    ...
    fillRectangle(objectX, objectRow, ENEMY_SIZE, ENEMY_SIZE, ENEMY_COLOR);
...
void __attribute__((interrupt(PORT1_VECTOR))) Port_1() {
    ...
    } else if (P1IFG & BIT2) { // Pause button pressed
